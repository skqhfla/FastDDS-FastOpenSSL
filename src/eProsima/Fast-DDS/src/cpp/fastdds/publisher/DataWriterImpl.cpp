    ...
    , lifespan_duration_us_(qos_.lifespan().duration.to_ns() * 1e-3)
{
    ...
    std::cout << "make datawriterimpl 1 : " << guid_ << std::endl;
    std::cout << "endpoint entityId : " << qos_.endpoint().user_defined_id << std::endl;
}
    ...
    , lifespan_duration_us_(qos_.lifespan().duration.to_ns() * 1e-3)
{
    ...
    std::cout << "make datawriterimpl 2 : " << guid_ << std::endl;
}
...
ReturnCode_t DataWriterImpl::enable()
{
    ...
    std::cout << "start writer make : " << guid_.entityId << std::endl;
            ...
            w_att.endpoint.data_sharing_configuration().kind() == DataSharingKind::AUTO)
    {
        ...
        std::cout << "start writer make second" << std::endl;
    ...
    std::cout << "call enable end" << std::endl;
